...
const SYSCTL_PERF_CONF: &str = "/etc/sysctl.d/99-lar-performance.conf";
const TMPFILES_PERF_CONF: &str = "/etc/tmpfiles.d/99-lar-performance.conf";
...
fn persist_sysctl_perf(key: &str, value: &str) {
    ...
    let header = "# Managed by Lar - Performance Optimizer\n\
